...
/** This is an auto generated class representing the BuyerPushToken type in your schema. */
@SuppressWarnings("all")
@ModelConfig(pluralName = "BuyerPushTokens", authRules = {
...
public final class BuyerPushToken implements Model {
  ...
  private BuyerPushToken(String id, String userId, String token) {
    this.id = id;
    this.userId = userId;
    this.token = token;
  }
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      BuyerPushToken buyerPushToken = (BuyerPushToken) obj;
      return ObjectsCompat.equals(getId(), buyerPushToken.getId()) &&
              ObjectsCompat.equals(getUserId(), buyerPushToken.getUserId()) &&
              ObjectsCompat.equals(getToken(), buyerPushToken.getToken());
      }
  }
   ...
   */
  public static BuyerPushToken justId(String id) {
    try {
